...
{
    /// <summary>
    /// This class implements the "hg tip" command (http://www.selenic.com/mercurial/hg.1.html#tip):
    /// retrieve the tip revision.
    /// </summary>
    public sealed class TipCommand : CommandBase<TipCommand>, IMercurialCommand<Changeset>
    {
        /// <summary>
        ...
        public override IEnumerable<string> Arguments
        {
            get
            {
                return base.Arguments.Concat(new[] { "--style=XML" });
            }
        }
