...
namespace Mercurial.Configuration
{
    ...
    public sealed class ClientConfigurationCollection : IEnumerable<ConfigurationEntry>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientConfigurationCollection"/> class.
        /// </summary>
        public ClientConfigurationCollection()
        {
            Refresh();
        }
        ...
        public IEnumerator<ConfigurationEntry> GetEnumerator()
        {
            ...
            foreach (ConfigurationEntry entry in result)
                yield return entry;
        }
