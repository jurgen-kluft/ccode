...
namespace Mercurial
{
    ...
    public sealed class Annotation : IEquatable<Annotation>
    {
        ...
        /// <summary>
        /// The zero-based line number for this <see cref="Annotation"/>.
        /// </summary>
        ...
        /// <summary>
        /// The revision number of the changeset that last modified the line in this
        /// <see cref="Annotation"/>.
        /// </summary>
        ...
        /// <summary>
        /// The annotated version of that line.
        /// </summary>
        public string Line
        {
            get
