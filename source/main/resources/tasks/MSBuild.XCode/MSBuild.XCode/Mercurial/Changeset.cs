...
namespace Mercurial
{
    ...
    public sealed class Changeset : IEquatable<Changeset>
    {
        ...
        /// <summary>
        /// The timestamp of this <see cref="Changeset"/>.
        /// </summary>
        ...
        /// <summary>
        /// The name of the author of this <see cref="Changeset"/>.
        /// </summary>
        ...
        /// <summary>
        /// The email address of the author of this <see cref="Changeset"/>.
        /// </summary>
        ...
        /// <summary>
        /// The commit message of this <see cref="Changeset"/>.
        /// </summary>
        ...
        /// <summary>
        /// The branch this <see cref="Changeset"/> is on.
        /// </summary>
        ...
        /// <summary>
        /// The unique hash of this <see cref="Changeset"/>.
        /// </summary>
        public string Hash
        {
            get;
        ...
        /// <summary>
        /// The locally unique revision number of this <see cref="Changeset"/>.
        /// </summary>
        ...
        /// <summary>
        /// The locally unique revision number of the left parent, or -1 if this is the initial changeset.
        /// </summary>
        ...
        /// <summary>
        /// The hash of the left parent, or <see cref="String.Empty"/> if this is the initial changeset.
        /// </summary>
        ...
        /// <summary>
        /// The locally unique revision number of the right parent, or -1 if this is the initial changeset.
        /// </summary>
        ...
        /// <summary>
        /// The hash of the right parent, or <see cref="String.Empty"/> if this is the initial changeset.
        /// </summary>
        ...
        /// <summary>
        /// The collection of path actions this changeset contains.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof (Changeset)) return false;
        ...
        {
            return String.Format(CultureInfo.InvariantCulture, "{0}:{1} - {2} <{3}> ({4})", RevisionNumber, Hash, AuthorName, AuthorEmailAddress,
                Timestamp);
        }
    }
}