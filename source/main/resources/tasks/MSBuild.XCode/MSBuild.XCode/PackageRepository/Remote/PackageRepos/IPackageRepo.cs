...
namespace xpackage_repo
{
    ...
    public interface IPackageRepo
    {
        ...
        /// </summary>
        bool upLoad(string Name, string Group, string Language, string Platform, string Branch, int Version, string Datetime, string Changeset, List<KeyValuePair<string, int>> dependencies, string localFilename);
        ...
        bool find(string package_name, string package_group, string package_language, string platform, string branch, out int version);
        bool find(string package_name, string package_group, string package_language, string platform, string branch, int version, out Dictionary<string, object> vars);
        bool find(string package_name, string package_group, string package_language, string platform, string branch, int start_version, bool include_start, int end_version, bool include_end, out Dictionary<string, object> vars);
    }
}
