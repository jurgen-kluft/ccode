...
func (r *JsonReader) ParseFloat32(field jsonField) float32 {
	if !r.Context.isValidField(field) {
		return 0.0
	}
...
func (r *JsonReader) ParseFloat64(field jsonField) float64 {
	if !r.Context.isValidField(field) {
		return 0.0
	}
...
func (context *jsonContext) ParseBegin(json string) bool {
	context.Json = json
	context.Cursor = 0
