set PACKAGE_REPO1=J:\Dev.C++.Packages\PACKAGE_REPO
...
set PACKAGE_REPO2=J:\Dev.C++.Packages\REMOTE_PACKAGE_REPO
...
set PACKAGE_REPO3=J:\Dev.C#.Packages\PACKAGE_REPO
...
set PACKAGE_REPO4=J:\Dev.C#.Packages\REMOTE_PACKAGE_REPO
